<?php
    ...
    if(isset($_POST['save'])){
        ...
        if (validate_field($customer->firstname) && 
        validate_field($customer->lastname) &&
        validate_field($customer->email) &&
        validate_field($customer->password) && validate_password($customer->password)){
            //proceed with saving
            if($customer->add()){
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4">      
                    ...
                    <form action="" method="post">
                        ...
                        <div class="mb-3">
                            <button type="submit" name="save" class="btn btn-primary brand-bg-color btn-create-account">Create account</button>
                        </div>
                    </form>
